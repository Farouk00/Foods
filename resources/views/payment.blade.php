			...
			<div class="col-md-6">
				<div class="box_style_2">
					...
					<div class="payment_select" id="paypal">
						<label><input type="radio" value="1"   name="payment_method" >Pay with paypal</label>
      ...
      return actions.payment.execute().then(function() { // result
        ...
        window.alert('Thank you for your purchase!');
					...
					<div class="payment_select nomargin">
						<label><input type ="radio" value="0" name="payment_method" checked="checked"  >Pay with cash</label>
