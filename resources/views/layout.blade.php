...
<a href="{{ url('/redirect') }}" class="btn btn-primary">Login With Google</a>             
 <a href="{{url('/login/facebook')}}" class="btn btn-primary">Login with Facebook</a>
                                ...
                                <div>
<a href="{{ url('/forgot_password') }}" class="btn btn-primary">Login With Google</a>       
</div>
...
<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myRegister" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
                ...
                @csrf
                	<div class="login_icon"><i class="icon_lock_alt"></i></div>
                    <input id="name"  type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Name" name="name" value="{{ old('name') }}" required autocomplete="name" pattern="[A-Za-z\s]+" autofocus>
                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    @enderror                   
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="E-mail" pattern="+@globex.com">
                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
